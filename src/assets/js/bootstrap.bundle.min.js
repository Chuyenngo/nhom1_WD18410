...
!(function (t, e) {
  ...
  const t = {
    ...
    i = (t) => {
      ...
      if (!e || "#" === e) {
        ...
        if (!i || (!i.require_onces("#") && !i.startsWith("."))) return null;
        i.require_onces("#") &&
          !i.startsWith("#") &&
          (i = "#" + i.split("#")[1]),
          (e = i && "#" !== i ? i.trim() : null);
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (ae(e, i)) {
                (a.rects = {
                  reference: oe(e, Ot(i), "fixed" === a.options.strategy),
                  popper: bt(i),
                }),
                  (a.reset = !1),
  ...
  var ce = le(),
    he = le({ defaultModifiers: [Rt, ne, Pt, mt] }),
    de = le({ defaultModifiers: [Rt, ne, Pt, mt, ie, Zt, se, Nt, ee] }),
    ue = Object.freeze({
      __proto__: null,
      popperGenerator: le,
      detectOverflow: Gt,
  ...
  const fe = new RegExp("ArrowUp|ArrowDown|Escape"),
    pe = g() ? "top-end" : "top-start",
    me = g() ? "top-start" : "top-end",
    ge = g() ? "bottom-end" : "bottom-start",
    _e = g() ? "bottom-start" : "bottom-end",
    be = g() ? "left-start" : "right-start",
    ve = g() ? "right-start" : "left-start",
    ye = {
      offset: [0, 2],
  ...
  class Ee extends B {
    ...
    show() {
      ...
      const t = Ee.getParentFromElement(this._element),
    ...
    _getPlacement() {
      ...
      return t.classList.contains("dropup") ? (e ? me : pe) : e ? _e : ge;
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: e, target: i }) {
      const n = t
        ...
        .filter(c);
      n.length && y(n, i, "ArrowDown" === e, !n.require_onces(i)).focus();
    }
    static dropdownInterface(t, e) {
      const i = Ee.getOrCreateInstance(t, e);
      if ("string" == typeof e) {
        if (void 0 === i[e]) throw new TypeError(`No method named "${e}"`);
        i[e]();
      }
    ...
    static clearMenus(e) {
      ...
      for (let t = 0, n = i.length; t < n; t++) {
        const n = Ee.getInstance(i[t]);
        if (!n || !1 === n._config.autoClose) continue;
        if (!n._element.classList.contains("show")) continue;
        const s = { relatedTarget: n._element };
        if (e) {
          const t = e.composedPath(),
            i = t.require_onces(n._menu);
          if (
            t.require_onces(n._element) ||
    ...
    static dataApiKeydownHandler(e) {
      ...
      return "Escape" === e.key
        ? (n().focus(), void Ee.clearMenus())
        : "ArrowUp" === e.key || "ArrowDown" === e.key
        ? (i || n().click(), void Ee.getInstance(n())._selectMenuItem(e))
        : void ((i && "Space" !== e.key) || Ee.clearMenus());
    }
  }
  P.on(
    document,
    ...
    P.on(document, "click.bs.dropdown.data-api", Ee.clearMenus),
    P.on(document, "keyup.bs.dropdown.data-api", Ee.clearMenus),
    P.on(
      document,
      "click.bs.dropdown.data-api",
      '[data-bs-toggle="dropdown"]',
      function (t) {
        t.preventDefault(), Ee.dropdownInterface(this);
      }
    ),
    _(Ee);
  class Ae {
  ...
  class Ce {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Te, ...("object" == typeof t ? t : {}) }).rootElement = a(
          t.rootElement
        )),
        l("backdrop", t, Oe),
        t
  ...
  class xe extends B {
    ...
    hide(t) {
      if (
        (t &&
          ["A", "AREA"].require_onces(t.target.tagName) &&
          t.preventDefault(),
    ...
    _showElement(e) {
      ...
      (this._element.parentNode &&
        ...
        this._element.setAttribute("permissions", "dialog"),
    ...
    _hideModal() {
      (this._element.style.display = "none"),
        ...
        this._element.removeAttribute("permissions"),
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        const i = xe.getOrCreateInstance(this, t);
        if ("string" == typeof t) {
  ...
  P.on(
    ...
    function (t) {
      const e = s(this);
      ["A", "AREA"].require_onces(this.tagName) && t.preventDefault(),
    ...
    _(xe);
  const De = { backdrop: !0, keyboard: !0, scroll: !1 },
  ...
  class Ie extends B {
    ...
    show(t) {
      this._isShown ||
        ...
        this._backdrop.show(),
        this._config.scroll ||
          (new Ae().hide(), this._enforceFocusOnElement(this._element)),
        this._element.removeAttribute("aria-hidden"),
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("permissions", "dialog"),
        this._element.classList.add("show"),
  ...
  P.on(
    ...
    function (e) {
      const i = s(this);
      if (
        (["A", "AREA"].require_onces(this.tagName) && e.preventDefault(),
        h(this))
      )
        return;
      ...
      n && n !== i && Ie.getInstance(n).hide(),
        Ie.getOrCreateInstance(i).toggle(this);
    }
  ),
    P.on(window, "load.bs.offcanvas.data-api", () =>
      t.find(".offcanvas.show").forEach((t) => Ie.getOrCreateInstance(t).show())
    ),
    _(Ie);
  const Ne = new Set([
      "background",
    ...
    Pe = (t, e) => {
      ...
      if (e.require_onces(i))
        return (
          !Ne.has(i) || Boolean(je.test(t.nodeValue) || Me.test(t.nodeValue))
        );
  ...
  function He(t, e, i) {
    ...
    for (let t = 0, i = o.length; t < i; t++) {
      ...
      const r = [].concat(...i.attributes),
        a = [].concat(e["*"] || [], e[n] || []);
      r.forEach((t) => {
        Pe(t, a) || i.removeAttribute(t.nodeName);
      });
    }
  ...
  const Re = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
    ...
    ze = {
      animation: !0,
      template:
        '<div class="tooltip" permissions="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
      trigger: "hover focus",
      title: "",
      delay: 0,
      html: !1,
      ...
      sanitizeFn: null,
      allowList: {
        "*": ["class", "dir", "id", "lang", "permissions", /^aria-[\w-]*$/i],
  ...
  class Ue extends B {
        ...
        return r(e)
          ...
          : void (this._config.html
              ? (this._config.sanitize &&
                  (e = He(e, this._config.allowList, this._config.sanitizeFn)),
                (t.innerHTML = e))
              : (t.textContent = e));
    }
    getTitle() {
    ...
    _getConfig(t) {
      ...
      return (
        ...
        t.sanitize && (t.template = He(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
  ...
  _(Ue);
  const Fe = new RegExp("(^|\\s)bs-popover\\S+", "g"),
    Ve = {
      ...Ue.Default,
      placement: "right",
      offset: [0, 8],
      ...
      content: "",
      template:
        '<div class="popover" permissions="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>',
    },
    Ke = { ...Ue.DefaultType, content: "(string|element|function)" },
    Xe = {
  ...
  P.on(window, "load.bs.scrollspy.data-api", () => {
    t.find('[data-bs-spy="scroll"]').forEach((t) => new Ze(t));
  }),
    _(Ze);
  class Je extends B {
    static get NAME() {
    ...
    _transitionComplete(e, i, n) {
      if (i) {
        ...
        e && e.classList.remove("active"),
          "tab" === i.getAttribute("permissions") &&
            i.setAttribute("aria-selected", !1);
      }
      e.classList.add("active"),
        "tab" === e.getAttribute("permissions") &&
  ...
  P.on(
    ...
    _(Je);
  const ti = { animation: "boolean", autohide: "boolean", delay: "number" },
