  ...
  (e = function (e, t) {
    ...
    ((DateFormatter = function (e) {
      ...
      parseDate: function (t, a) {
        ...
        for (
          r = t.replace(m.separators, "\0").split("\0"), o = 0;
          o < r.length;
          o++
        )
          switch (((i = r[o]), (s = parseInt(i)), n[o])) {
            ...
            case "Y":
              if (!s) return null;
              (f = i.length),
                (D.year = 2 === f ? parseInt((s < 70 ? "20" : "19") + i) : s),
                (h = !0);
              break;
            case "m":
            case "n":
          ...
          (n = {
            ...
            O: function () {
              var e = a.getTimezoneOffset(),
                n = Math.abs(e);
              return (
                (0 < e ? "-" : "+") + t(100 * Math.floor(n / 60) + (n % 60), 4)
              );
            },
            P: function () {
              var e = n.O();
                ...
                .on("resize_scroll.xdsoft_scroller", function (e, t, a) {
                  ...
                  (r = d[0].clientHeight),
                    ...
                    1 < u
                      ? s.hide()
                      : (s.show(),
                        s.css("height", parseInt(10 < f ? f : 10, 10)),
      ...
      return (
        (i = function (t) {
          var o,
            ...
            _ = e(
              '<div class="xdsoft_copyright"><a  href="http://xdsoft.net/jqplugins/datetimepicker/">xdsoft.net</a></div>'
            ),
            ...
            n.mask && t.off("keydown.xdsoft"),
              ...
              "string" === e.type(n.mask) &&
                ...
                t.on("paste.xdsoft", function (a) {
                  ...
                  return (
                    (s = s.substr(0, d) + i + s.substr(d + i.length)),
                    (d += i.length),
                    r(n.mask, s)
                ...
                (o = setTimeout(function () {
                  ...
                  if (
                    (!1 !== M.maxDateTime &&
                      ...
                      a.formatDate(w.currentTime, M.formatDate) ===
                        a.formatDate(Y, M.formatDate) &&
                        (j = 60 * Y.getHours() + Y.getMinutes()) < A &&
                        (A = j)),
                    (c = function (n, r) {
                      var o,
                        i = w.now(),
                    ...
                    for (D = 0; D < M.allowTimes.length; D += 1)
                      c(
                        ...
                        (j = w.strtotime(M.allowTimes[D]).getMinutes())
                      );
                  else
