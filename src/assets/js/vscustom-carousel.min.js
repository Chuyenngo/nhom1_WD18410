    ...
    $(this).each(function () {
      ...
      vsSlide.slick({
        ...
        prevArrow: d("prev-arrow")
          ? prevButton
          : '<button type="button" class="slick-prev"><i class="fal fa-arrow-left"></i>Prev</button>',
        nextArrow: d("next-arrow")
          ? nextButton
          : '<button type="button" class="slick-next">Next<i class="fal fa-arrow-right"></i></button>',
