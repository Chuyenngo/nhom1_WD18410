    ...
    return this.each(function () {
      ...
      function o() {
        i < s.expandScreenWidth
          ? (g.css("display", "none"),
            e(s.menuContainer).css("display", ""),
            e(s.menuBody).css("display", ""))
          : (g.css("display", ""),
          ...
          e(this).on("click", function (n) {
            n.preventDefault(),
              ...
              e(s.menuBody).length > 0 &&
                e(s.menuBody).toggleClass(s.bodyToggleClass),
              e(s.menuContainer).length > 0 &&
                e(s.menuContainer).toggleClass(s.menuToggleClass),
              a();
          });
        }),
        e(s.menuBody).length > 0 &&
