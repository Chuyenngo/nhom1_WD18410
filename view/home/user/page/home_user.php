...
<head>
  ...
  <title>Men Shop - Shop Details</title>
  ...
  <div class="preloader  ">
    ...
    <div class="preloader-inner">
      <div class="loader-logo">
        <img src="./src/assets/img/logo.jpg" width="100px" alt="FeeTech">
      </div>
    ...
    <div class="container position-relative">
      <div class="row align-items-center">
        <div class="col-5 col-md-3">
          <div class="logo">
            <a href="index.php?controller=home"><img src="./src/assets/img/logo.jpg" alt="FeeTech" width="100px"></a>
          </div>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-6">
          <div class="header-logo">
            <a href="index.php?controller=home"><img src="./src/assets/img/logo.jpg" width="100px" alt="FeeTech"></a>
          </div>
        </div>
                        ...
                        <div class="tab-content">
                          <div class="tab-pane fade active show" data-tab="login" id="login" aria-labelledby="login-tab">
                            <form method="post" class="woocommerce-form login">
                              ...
                              <p><a href="index.php?controller=edit_user" class="btn-inline">Update Infomation</a></p>
                              <p><a href="index.php?controller=forgot_password" class="btn-inline">Forgot Your Password?</a></p>
                              ...
                              if ($_SESSION['user']['permissions'] == 1 || $_SESSION['user']['permissions'] == 2) {
                                echo '<p><a href="admin_" class="btn-inline">Login Admin</a></p>';
                              }
                              ?>
  ...
  <footer class="footer-wrapper footer-layout1">
    <div class="container">
          ...
          <div class="col-sm-6 col-lg-4 col-xl-3">
            <div class="widget footer-widget  ">
              ...
              <div class="vs-widget-about">
                ...
                <p class="mb-1 link-inherit"><i class="fas fa-paper-plane me-3"></i><a href="mailto:chuyenngo203@example.com">chuyengo203@gmail.com</a></p>
      ...
      <div class="copyright text-center pb-35">
        <p class="mb-0 link-inherit">Copyright &copy; 2022 <a href="index.php?controller=home"> Men Shop</a> </p>
      </div>
    </div>
  </footer>
  </div>
