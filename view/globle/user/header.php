...
<head>
    ...
    <meta name="description" content="Shop Men" />
    ...
    <!-- <div class="preloader">
        ...
        <div class="preloader-inner">
            <div class="loader-logo">
                <img src="./src/assets/img/logo.jpg" alt="FeeTech" width="100px" />
            </div>
                    ...
                    <div class="col-lg-auto text-center text-lg-end">
                        <div class="header-infos">
                            ...
                            <p class="info d-none d-md-inline-block">
                                <i class="fas fa-envelope"></i>Email:<a href="mailto:menshop@gmail.com">menshop@gmail.com</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col col-lg-auto">
                        <div class="header-logo" style="background-color: green;">
                            <a href="index.php?controller=home"><img src="./src/assets/img/logo.jpg" alt="FeeTech" width="100px" /></a>
                        </div>
                    </div>
                    <div class="col-auto">
