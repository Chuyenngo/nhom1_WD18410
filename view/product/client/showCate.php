...
<div class="breadcumb-wrapper breadcumb-layout1 bg-fluid pt-200 pb-200" data-bg-src="./src/assets/img/breadcumb/breadcumb-img-1.jpg">
    <div class="container">
        <div class="breadcumb-content text-center">
            <h1 class="breadcumb-title">Men Shop</h1>
                                    ...
                                    <div class="col-sm-6 col-xl-4">
                                        <div class="vs-product-box1 thumb_swap">
                                            ...
                                            <div class="product-img">
                                                <a href="<?php echo $linkpro . $value->getId(); ?>"><img src="admin_/uploads/products/<?php echo $value->getImage(); ?>" alt="Product Image" class="w-100 h-300"></a>
