...
?>
<div class="breadcumb-wrapper breadcumb-layout1 bg-fluid pt-200 pb-200" data-bg-src="./src/assets/img/breadcumb/breadcumb-img-1.jpg" style="background-image: url(./src/assets/img/breadcumb/breadcumb-img-1.jpg);">
    <div class="container">
                                ...
                                <div class="col-sm-6 col-xl-4">
                                    <div class="vs-product-box1 thumb_swap">
                                        ...
                                        <div class="product-img">
                                            <a href=<?php echo $linkpro . $product->getId(); ?>><img src="admin_/uploads/products/<?php echo $product->getImage() ?>" alt="Product Image" class="w-100" height="300px"></a>
